...
export const chapters: Chapter[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          '1 microliter = 10⁻⁶ liters',
          '1 gram = 10³ kilograms',
          '10³ milliliters = 1 liter',
          '1 gram = 10² centigrams',
          '10 decimeters = 1 meter',
        ],
        correctAnswer: '1 gram = 10³ kilograms',
        explanation: '1 gram = 10⁻³ kilograms, not 10³.',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        explanation: "Deci means 10⁻¹, not 10.",
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        explanation: 'Nano (10⁻⁹) < milli (10⁻³) < centi (10⁻²) < kilo (10³).',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        correctAnswer: '8.1 × 10³',
        explanation: '1 kg = 1000 g → 8.1 kg = 8.1 × 10³ g',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        explanation: '1 m = 1000 mm → 0.3980 × 1000 = 398.0 mm',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        correctAnswer: '6.1 × 10¹²',
        explanation: '1 second = 10¹² picoseconds → 6.1 × 10¹² ps',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        correctAnswer: '9.49 × 10⁹',
        explanation: '1 second = 10⁹ nanoseconds → 9.49 × 10⁹ ns',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        correctAnswer: '2.1 × 10⁴ m',
        explanation: '1 km = 1000 m → 21 × 1000 = 21,000 = 2.1 × 10⁴ m',
        difficulty: 'Easy',
        reference: '1.3',
        keyConcepts: [
          'Chemistry',
      ...
      },
      {
        ...
        explanation: 'Values are close to each other (precise), but not near 1.000 g (inaccurate).',
        difficulty: 'Easy',
        reference: '1.4',
        keyConcepts: [
          'Chemistry',
